                ...
                <div class="text-muted font-13">
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{env('BUYER_USERNAME')}}" value="NullJungle" class="form-control" id="username"
                                   name="username" required>
                        </div>

                        <div class="form-group">
                            <label for="purchase_code">Purchase Code</label>
                            <input type="text" value="{{env('PURCHASE_CODE')}}" value="Nulled-By-NullJungle" class="form-control" id="purchase_key"
